...
(
    ...
    'Spirit Island',
    2017,
    'Golden Geek Best Cooperative Game 2017',
    'I spiller som ånder der forsvarer en ø — mange café-grupper elsker at kombinere kræfter mod kolonisterne.',
    'https://en.wikipedia.org/wiki/Spirit_Island_(board_game)'
),
(
    'hanabi',
    'Hanabi',
    ...
    'I må ikke se egne kort — kommunikation med hints er halvdelen af spillet ved et stille cafébord.',
...
(
    ...
    'Fluxx',
    1997,
    'Mensa Select 1999; kaotiske regler der skifter',
    'Reglerne ændrer sig midt i spillet — perfekt når gæsterne griner over uventede vendinger.',
...
(
    ...
    'UNO',
    1971,
    'Verdens mest solgte kortspil; Mattel',
    'Næsten alle kender en husregel der ikke står i manualen — det er en del af charmen i spilcaféen.',
    'https://da.wikipedia.org/wiki/Uno_(kortspil)'
),
(
    'jungle-speed',
    'Jungle Speed',
    1991,
    'Party-klassiker; Asmodée',
    'Totemstaven flyver hen over bordet — caféen bliver højlydt på under et minut.',
...
(
    ...
    'One Night Ultimate Werewolf',
    2014,
    'Party-spil; opfølger til Ultimate Werewolf',
    'Hele spillet tager én nat — ideelt når I vil have social deduktion uden lang opsætning.',
    'https://en.wikipedia.org/wiki/One_Night_Ultimate_Werewolf'
),
(
    'the-resistance',
    'The Resistance',
    2009,
    'Golden Geek Best Party Game 2009',
    'Spioner vs. modstandere uden at nogen dør — bluff og stemmer gør det café-venligt for 5–10 spillere.',
    'https://en.wikipedia.org/wiki/The_Resistance_(party_game)'
),
(
    'secret-hitler',
    'Secret Hitler',
    2016,
    'Kickstarter-succes; politisk bluff',
    'Liberaler og fascister skjuler roller — mange grupper spiller det som “den seriøse aften” med snacks.',
...
(
    ...
    'Coup',
    2012,
    'Populært bluff-kortspil; Indie Boards & Cards',
    'Kortspil der passer i lommen — ofte taget frem mens I venter på andre gæster ved baren.',
...
(
    ...
    'Skull',
    2011,
    'Bluff og bud; oprindeligt offentligt domæne',
    'Kun få brikker og kopper — men spændingen ved at bluffe føles enorm ved et lille bord.',
...
(
    ...
    'Betrayal at House on the Hill',
    2004,
    'Golden Geek Best Thematic Game 2004',
    'Huset bygges undervejs — hver session får sin egen “film”-fortælling i caféen.',
...
(
    ...
    'Small World',
    2009,
    'Origins Award Best Family Game 2010',
    'Racer går “in decline” og vælges nye — sjovt at se hvem der dominerer midt i spillet.',
...
(
    ...
    'Dominion',
    2008,
    'Spiel des Jahres 2009; deck-building-pioner',
    'Første store deck-building-spil — mange caféer har flere udvidelser på hylden.',
...
(
    ...
    'Tilpasset to spillere med militær, videnskab og wonder-tracks — fast 2-personers bord i caféen.',
...
(
    ...
    'Jaipur',
    2009,
    'Golden Geek Best 2-Player Board Game 2010',
    'Handel med kamel, juveler og tekstil på under 30 minutter — klassisk “date night”-spil.',
    'https://en.wikipedia.org/wiki/Jaipur_(board_game)'
),
(
    'lost-cities',
    'Lost Cities',
    1999,
    'Spiel des Jahres nomineret; 2-spillers Reiner Knizia',
    'Kortstakke der vokser som ekspeditioner — let at lære, svært at lægge perfekt.',
...
(
    ...
    'Hive',
    2001,
    'Mensa Select 2006; brikspil uden bræt',
    'Ingen bræt — kun brikker der klatrer. Perfekt på små caféborde med kaffe.',
...
(
    ...
    'Onitama',
    2014,
    'Abstract 2-spillers; bevægelseskort skifter',
    'Som skak med skiftende bevægelser — en runde tager ofte under 20 minutter.',
...
(
    ...
    'Santorini',
    2017,
    'Golden Geek Best Abstract Game 2017',
    'Byg tårne på en ø — guder-kortene giver uventede twists selv for erfarne spillere.',
    'https://en.wikipedia.org/wiki/Santorini_(board_game)'
),
(
    'telestrations',
    'Telestrations',
    2009,
    'Party-klassiker; tegn og gæt-kæde',
    'Dårlige tegninger er pointen — caféen griner højlydt når “kat” bliver til “raket”.',
    'https://en.wikipedia.org/wiki/Telestrations'
),
(
    'just-one',
    'Just One',
    ...
    'Alle skriver ét hint — duplikater slettes. Samarbejde uden at det føles tungt.',
...
(
    ...
    'Decrypto',
    2018,
    'Party-spil; kodeknækning mellem hold',
    'Hold sender kodede beskeder — modstanderen lytter med og prøver at knække mønsteret.',
    'https://en.wikipedia.org/wiki/Decrypto'
),
(
    'the-mind',
    'The Mind',
    2018,
    'Spiel des Jahres nomineret; kooperativt kortspil',
    'Ingen snak — kun timing og øjenkontakt. Stilleste (eller mest anspændte) bord i caféen.',
...
(
    ...
    'No Thanks!',
    2004,
    'Klassisk “push your luck”; Goliath / Amigo',
    'Afvis kort med chips — den der har lavest total vinder. Hurtig filler mellem retter.',
    'https://en.wikipedia.org/wiki/No_Thanks!_(card_game)'
),
(
    'diamant',
    'Diamant',
    2005,
    'Spiel des Jahres nomineret (som Incan Gold)',
    'Gå dybere i hulen eller vend hjem — samme spil som Incan Gold med andet tema.',
    'https://en.wikipedia.org/wiki/Incan_Gold'
),
(
    'camel-up',
    'Camel Up',
    ...
    'Kameler stables og væddes på — pyramiden med terninger er et lille showpiece på bordet.',
...
(
    ...
    'Colt Express',
    2014,
    'As d''Or 2015; Spiel des Jahres 2015',
    'Programmer handlinger i et tog — den 3D-togbane får ofte fotos fra gæster.',
...
(
    ...
    'Qwirkle',
    2006,
    'Spiel des Jahres 2011; Mensa Select',
    'Farver og former i rækker — børn og voksne kan sidde ved samme cafébord.',
...
(
    ...
    'Blokus',
    2000,
    'Mensa Select 2004; tetris-lignende placering',
    'Fyld brættet med dine brikker — sidste brikker er ofte umulige og giver god debat.',
...
(
    ...
    'PARKS',
    2019,
    'Golden Geek Best Thematic Game 2019',
    'Besøg amerikanske nationalparker med smukke illustrationer — hyggespil med vandringstema.',
    'https://en.wikipedia.org/wiki/Parks_(board_game)'
),
(
    'ark-nova',
    'Ark Nova',
    2021,
    'Golden Geek Best Heavy Strategy 2021',
    'Byg et moderne zoo med kort og dyr — populært blandt strategi-gæster der booker lange sessioner.',
...
(
    ...
    'Stone Age',
    2008,
    'Deutscher Spiele Preis 2008; worker placement-klassiker',
    'Terninger bestemmer ressourcer — mange husker “brød”-reglen fra deres første café-aften.',
    'https://en.wikipedia.org/wiki/Stone_Age_(board_game)'
),
(
    'lords-of-waterdeep',
    'Lords of Waterdeep',
    2012,
    'Golden Geek Best Strategy Game 2012',
    'Dungeons & Dragons-byen som arbejdsplads — quest-brikker gør worker placement let at forklare.',
...
(
    ...
    2011,
    'Golden Geek Best Strategy Game 2011',
    'Terninger og felter i ren strategi — elsket af spillere der vil have “én mere runde”.',
...
(
    ...
    'Heat: Pedal to the Metal',
    2022,
    'Golden Geek Best Racing Game 2023',
    'Formel 1 med håndstyring af hastighed — adrenalinfyldt uden at være et videospil.',
...
(
    ...
    'Brass: Birmingham',
    2018,
    'Golden Geek Best Heavy Strategy 2018',
    'Industrielt England på bræt — ofte reserveret til erfarne gæster der vil have en hel eftermiddag.',
...
(
    ...
    'Blood Rage',
    2015,
    'Golden Geek Best Thematic Game 2015',
    'Vikinger og Ragnarok med miniatyrer — draft og kamp i samme kasse.',
    'https://en.wikipedia.org/wiki/Blood_Rage_(board_game)'
),
(
    'power-grid',
    'Power Grid',
    2004,
    'Deutscher Spiele Preis 2005; økonomi og netværk',
    'Auktioner om kraftværker — turn order drejer om, så den der ligger sidst ofte vinder bud.',
...
(
    ...
    'Race for the Galaxy',
    2007,
    'Golden Geek Best Card Game 2008',
    'Ikoner i stedet for lang tekst — når I kan symbolerne, går runder lynhurtigt.',
...
(
    ...
    2019,
    'Kennerspiel des Jahres 2020; kooperativt trick-taking',
    '50 missioner med stigende sværhedsgrad — perfekt til faste stamkunder i caféen.',
...
(
    ...
    'Rhino Hero',
    2011,
    'Kinderspiel des Jahres nomineret; stabling',
    'Et korttårn der vakler — børnefamilier og voksne spiller det med samme grin.',
    'https://en.wikipedia.org/wiki/Rhino_Hero'
),
(
    'timeline',
    'Timeline',
    2010,
    'Party / læring; Asmodeée',
    'Placer begivenheder i rækkefølge — I lærer ofte en mærkelig historiefact undervejs.',
    'https://en.wikipedia.org/wiki/Timeline_(card_game)'
),
(
    'hitster',
    'Hitster',
    2022,
    'Party-spil med musik; Jumbo',
    'Gæt årstallet for hits — mange caféer spiller det med højtaler fra gæsternes playliste.',
    'https://en.wikipedia.org/wiki/Hitster'
),
(
    'so-clover',
    'So Clover!',
    2021,
    'Party; ordforbindelser på tavle',
    'Skriv hemmelige ord der binder fire sammen — samarbejde med masser af “aha!”-øjeblikke.',
    'https://en.wikipedia.org/wiki/So_Clover!'
),
(
    'scout',
    'Scout',
    2021,
    'Spiel des Jahres nomineret; kortstakke og bud',
    'Vend kortstakke for at byde — reglerne er få, men dybden vokser efter ti minutter.',
    'https://en.wikipedia.org/wiki/Scout_(card_game)'
),
(
    'forbidden-island',
    'Forbidden Island',
    2010,
    'Gateway kooperativt; Matt Leacock',
    'Øen synker mens I samler skatte — lettere indgang end Pandemic for nye spillere.',
    'https://en.wikipedia.org/wiki/Forbidden_Island'
),
(
    'forbidden-desert',
    'Forbidden Desert',
    2013,
    'Opfølger til Forbidden Island',
    'Sandstorm og flyvende deler — kooperativt med mere “action” end den første ø.',
    'https://en.wikipedia.org/wiki/Forbidden_Desert'
),
(
    'flash-point-fire-rescue',
    'Flash Point: Fire Rescue',
    2011,
    'Golden Geek Best Thematic Game 2012',
    'Sluk brand og red mennesker — terninger og røg gør hver redning dramatisk.',
    'https://en.wikipedia.org/wiki/Flash_Point:_Fire_Rescue'
),
(
    'mysterium',
    'Mysterium',
    2015,
    'Golden Geek Best Party Game 2016',
    'Én spiller er spøgelse med billedkort — resten gætter mordet som et spøgelses-Cluedo.',
...
(
    ...
    'Dead of Winter',
    2014,
    'Golden Geek Best Thematic Game 2014',
    'Zombie-overlevelse med skjulte mål — nogen i gruppen lyver måske om intentioner.',
    'https://en.wikipedia.org/wiki/Dead_of_Winter:_A_Crossroads_Game'
),
(
    'bang-the-dice-game',
    'Bang! The Dice Game',
    2013,
    'Vesterligen tema; terning-variant af Bang!',
    'Sherif, banditter og Renegade med terninger — hurtigere end originalen til en café-runde.',
...
(
    ...
    'Clank!',
    2016,
    'Golden Geek Best Family Game 2017',
    'Støj vækker dragen — deck-building i en dungeon med humor og risiko.',
    'https://en.wikipedia.org/wiki/Clank!_A_Deck-Building_Adventure'
),
(
    'quest-for-el-dorado',
    'The Quest for El Dorado',
    2017,
    'Spiel des Jahres 2017 nomineret; deck-building race',
    'Reiner Knizia kombinerer deck-building med løb — let at lære for familier.',
    'https://en.wikipedia.org/wiki/The_Quest_for_El_Dorado'
),
(
    'gloomhaven-jaws-of-the-lion',
    'Gloomhaven: Jaws of the Lion',
    2020,
    'Golden Geek Best Thematic Game 2020',
    'Kortere kampagne end Gloomhaven — mange caféer bruger den som “vi spiller det her fredag”.',
...
(
    ...
    'Monopoly Deal',
    2008,
    'Hurtig kortversion af Matador/Monopoly',
    'Fuldfør tre ejendomssæt med kort — Matador-fans får deres fix på 15 minutter.',
...
(
    ...
    'Scrabble',
    1938,
    'Klassisk ordspil; Hasbro / Mattel',
    'Dansk udgave findes — café-gæster diskuterer ofte om fremmedord må bruges.',
    'https://da.wikipedia.org/wiki/Scrabble'
),
(
    'cluedo',
    'Cluedo',
    1949,
    'Klassisk detektivspil; Hasbro',
    'Hvem, hvor og med hvad — mange kender karaktererne fra barndommen før første café-besøg.',
    'https://da.wikipedia.org/wiki/Cluedo'
),
(
    'backgammon',
    'Backgammon',
    -3000,
    'Et af verdens ældste spil; klassiker',
    'Terninger og dobbeltsten — nogle caféer har et fast bræt ved vinduet til stamspillere.',
...
(
    ...
    'Sequence',
    1982,
    'Familie-klassiker; Jax Ltd',
    'Fire på stribe med kort og jetoner — nemt at blande hold på et langt cafébord.',
...
(
    ...
    'Abalone',
    1987,
    'Mensa Select; strategisk 2-spillers',
    'Skub kugler i seks retninger — føles som skak med fysiske kugler der ruller.',
...
(
    ...
    'Pentago',
    2004,
    'Svensk design; drejende felter',
    'Fem på stribe — men feltet drejes efter hvert træk, så planen ændrer sig konstant.',
...
(
    ...
    'Werewolf',
    1986,
    'Klassisk social deduktion; Mafia-variant',
    'Ingen bræt — kun stemmer og roller. Stadig populært til store grupper i spilcaféer.',
...
(
    ...
    'Taboo',
    1989,
    'Party-klassiker; Hasbro',
    'Forklar ord uden forbudte termer — buzzeren på bordet skaber øjeblikkelig stemning.',
...
(
    ...
    'Sushi Go Party!',
    2016,
    'Udvidet version af Sushi Go!; op til 8 spillere',
    'Konfigurerbar menu med retter — caféen kan vælge “hurtig” eller “kaotisk” opsætning.',
    'https://en.wikipedia.org/wiki/Sushi_Go!'
),
(
    'werewords',
    'Werewords',
    2017,
    'Party; fra skaberen af One Night Werewolf',
    'Ordet skal gættes — men ulvene kender det hemmelige ord og saboterer.',
    'https://en.wikipedia.org/wiki/Werewords'
),
(
    'wavelength',
    'Wavelength',
...
(
    ...
    'Cartographers',
    2019,
    'Golden Geek Best Print & Play 2019; flip-and-write',
    'Tegn kort på et ark mens mål skifter — alle spiller samtidig uden at vente på tur.',
    'https://en.wikipedia.org/wiki/Cartographers_(board_game)'
),
(
    'viticulture',
    'Viticulture',
    2013,
    'Golden Geek Best Strategy 2015 (Essential Edition)',
    'Byg en vingård i Toscana — arbejdere og vinhøst giver hyggelig café-atmosfære.',
    'https://en.wikipedia.org/wiki/Viticulture_(board_game)'
),
(
    'tapestry',
    'Tapestry',
    2019,
    'Civilisations-opbygning; Stonemaier Games',
    'Fire civilisationer over flere tidsaldre — “én sidste runde” fylder ofte hele aftenen.',
    'https://en.wikipedia.org/wiki/Tapestry_(board_game)'
),
(
    'star-realms',
    'Star Realms',
    2014,
    'Golden Geek Best Card Game 2014',
    'Sci-fi deck-building duel — hurtige kampe mellem to gæster ved baren.',
    'https://en.wikipedia.org/wiki/Star_Realms'
),
(
    'marvel-champions',
    'Marvel Champions',
...
(
    ...
    'Calico',
    2020,
    'Golden Geek Best Abstract 2021',
    'Sy et tæppe af farvede lapper — katte-mål gør det sødt uden at være et børnespil.',
    'https://en.wikipedia.org/wiki/Calico_(board_game)'
),
(
    'planet',
    'Planet',
    2019,
    'Spiel des Jahres 2019; 3D-dodekaeder',
    'Hver spiller har sin egen lille planet — magnetiske felter giver wow ved første opsætning.',
    'https://en.wikipedia.org/wiki/Planet_(board_game)'
),
(
    'my-little-scythe',
    'My Little Scythe',
    2017,
    'Familie-version inspireret af Scythe',
    'Søde dyr i en konkurrence om tærter — gateway til Scythe-universet for yngre spillere.',
    'https://en.wikipedia.org/wiki/My_Little_Scythe'
),
(
    'obsidian-crown-c001',
    'Obsidian Crown',
